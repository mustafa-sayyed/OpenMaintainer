...
class PolicyEngine {
  ...
  async canUseTool(policyPayload: PolicyPayload, tool: Tool): Promise<boolean> {
    try {
    ...
    try {
      ...
      switch (action) {
        ...
        case 'mergePullRequest': {
          const actionPolicy = policy.permissions.actions.mergePullRequest;
          ...
          const pullRequestCondition = actionPolicy.condition?.pullRequest;
          ...
          return (
            pullRequestContext.author === pullRequestCondition.author &&
